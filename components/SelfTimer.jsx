            ...
            <div id='mainbody' className='flex bg-[url("/home_background5.svg")] bg-cover bg-center  h-screen w-full justify-center items-center'>
                <div className='w-3/4 px-36'>
                    <div className="flex justify-end items-center streak">
                        ...
                        <Image className='w-6 h-6 mr-4' src='/streak.png' alt='streak_img' width={500} height={500} />
                    </div>
                    <div className='timer backdrop-blur-md px-36 py-12 bg-[rgba(255,255,255,0.1)] text-[#392E33] bg-opacity-25 rounded-xl shadow-xl flex flex-col space-y-12  m-1 p-1 items-center'>
